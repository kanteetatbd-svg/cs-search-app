...
st.title("🚀 ระบบค้นหาข้อมูล CS (Version 5.0 - Final)")

# แก้ปัญหาการอ่านกุญแจโดยใช้ .replace เพื่อให้ระบบเห็นการขึ้นบรรทัดใหม่จริงๆ
...
config = {
  ...
  "private_key": raw_private_key.replace(r"\n", "\n"),
