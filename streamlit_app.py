...
st.title("🚀 ระบบค้นหาข้อมูล CS (Version 4.0)")

# แผนเผด็จการ: วางกุญแจตรงๆ ในรูปแบบ Dictionary (ตัดปัญหาเรื่อง \n)
config = {
...
@st.cache_data
def load_data():
    # เชื่อมต่อตรงๆ ผ่านตัวแปร config ไม่ผ่าน Secrets แล้วครับ
